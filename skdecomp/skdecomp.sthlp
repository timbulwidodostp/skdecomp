...
{p 8 12}{inp:. net install skdecomp, from("https://raw.githubusercontent.com/timbulwidodostp/skdecomp/main/skdecomp") replace}{p_end}

{p 8 12}{inp:. import excel "https://raw.githubusercontent.com/timbulwidodostp/skdecomp/main/skdecomp/skdecomp.xlsx", sheet("Sheet1") firstrow clear}{p_end}

{p 8 12}{inp:. skdecomp income, by(year) varpl(lp_4usd)}{p_end}

{p 8 12}{inp:. skdecomp income, by(year) varpl(lp_4usd) in(fgt0 fgt1 fgt2)}{p_end}
